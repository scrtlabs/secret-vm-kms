...
pub enum ExecuteMsg {
    ...
    CreateService { service_id: String, name: String, password_hash: Option<String> },
    ...
    AddSecretKeyByImage { image_filter: MsgImageFilter, password_hash: Option<String> },
    /// NEW: Add an env secret by image.
    AddEnvByImage { image_filter: MsgImageFilter, secrets_plaintext: String, password_hash: Option<String> },
...
pub enum QueryMsg {
    ...
    GetSecretKey { service_id: String, quote: Vec<u8>, collateral: Vec<u8>, password: Option<String> },
    /// Get secret key by image.
    GetSecretKeyByImage { quote: Vec<u8>, collateral: Vec<u8>, password: Option<String> },
    /// NEW: Get env secret by image.
    GetEnvByImage { quote: Vec<u8>, collateral: Vec<u8>, password: Option<String> },
